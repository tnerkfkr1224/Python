...
##                                                                                                ##
## Very simple - half broken - version. Can only support one connection at a time                 ##
##                                                                                                ##
...
def handle_client(client_socket):
    ...
    print(f'Accepted connection from: {remote_ip}:{remote_port}')
...
## loop accepting connections and handing them off to handle_client() to manage                   ##
####################################################################################################
def run_server(port):
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Simple Echo Server - blocking',
